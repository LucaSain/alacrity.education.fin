export default function AirBox() {
  return (
    <div className=" relative h-max bg-base-200 flex flex-col items-center py-20 ">
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-l from-primary via-base-200 to-primary opacity-40 brightness-150"></div>
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-primary via-base-200 to-primary opacity-40 brightness-150"></div>
      ...
      <p className=" z-10 text-xl max-w-4xl py-10 ">
        ...
        autonomous after install. <span className="text-secondary">Airbox</span>{" "}
        allows high-schoolers to gain real-world experience in programming and
